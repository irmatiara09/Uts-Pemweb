...
@section('content')
    <h5>Ubah Data Pembayaran Air</h5>
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" name="nama"
                    value="{{ old('nama') ?: $pembayaranair->nama }}">
                @if ($errors->has('nama'))
            ...
            <div class="col-md-6">
                Tanggal
                <input type="text" class="form-control {{ $errors->has('tanggal') ? 'is-invalid' : '' }}" name="tanggal"
            ...
            <div class="col-md-6">
                Nomor HP
                <input type="text" class="form-control {{ $errors->has('notelp') ? 'is-invalid' : '' }}" name="notelp"
                    value="{{ old('notelp') ?: $pembayaranair->notelp }}">
